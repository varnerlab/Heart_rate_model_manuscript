...
\begin{figure}[ht]
       ...
       \caption{The black marks are from cluster 1, the grey markss represent cluster 2. Error bars are omitted for the sake of clarity. Parameters represented by an x were allowed to vary, and parameters represented by a star were held constant.}
