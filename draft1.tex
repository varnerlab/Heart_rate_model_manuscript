...
To decrease the time neccessary to perform the simulated annealing, we utilized Julia's transparent parallization capabilities. With the @parallel (+) operator, we were able to calculate patient's mean squarred errors in parallel. The speed up from parallization is shown in \ref{fig:executiontime}. 
